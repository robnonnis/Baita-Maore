...
const TR = {
  it: {
    ...
    activities: [
      ...
      { emoji: "🚌", title: "Bus Vintage «Maoretto»", subtitle: "Picnic panoramico nel bosco", detail: "Uscita con il bus vintage Maoretto per un picnic in un punto panoramico o nel bosco.", price: "Set picnic € 75 a coppia", photos: ["https://res.cloudinary.com/dovpg47yh/image/upload/v1775488681/PHOTO-2026-03-29-20-52-16_12_jadhd9.jpg"], photoPosition: "center bottom" },
      { emoji: "🧺", title: "Aperitivo nel bosco", subtitle: "O in punto panoramico", detail: "Un aperitivo al tramonto nel bosco o in uno dei punti panoramici più suggestivi di Laconi.", photos: ["https://res.cloudinary.com/dovpg47yh/image/upload/v1774646471/IMG_9037_bh16nc.jpg"], photoPosition: "center bottom" },
    ],
  ...
  en: {
    ...
    activities: [
      ...
      { emoji: "🚌", title: "Vintage Bus «Maoretto»", subtitle: "Panoramic picnic in the woods", detail: "A trip aboard our vintage Maoretto bus to a scenic viewpoint or secret forest clearing for a picnic.", price: "Picnic set € 75 per couple", photos: ["https://res.cloudinary.com/dovpg47yh/image/upload/v1775488681/PHOTO-2026-03-29-20-52-16_12_jadhd9.jpg"], photoPosition: "center bottom" },
      { emoji: "🧺", title: "Aperitif in the woods", subtitle: "Or at a panoramic viewpoint", detail: "A sunset aperitif in the woods or at one of Laconi's most breathtaking viewpoints. A romantic and authentic experience.", photos: ["https://res.cloudinary.com/dovpg47yh/image/upload/v1774646471/IMG_9037_bh16nc.jpg"], photoPosition: "center bottom" },
    ],
    ...
    <div style={s.app}><FontLink/><LangToggle lang={lang} setLang={setLang}/>
      ...
      <div style={{padding:"0 20px",marginBottom:4}}>
        <a href="https://wa.me/393474029363" target="_blank" rel="noreferrer" style={{display:"flex",alignItems:"center",gap:14,background:"linear-gradient(135deg,#1c1208,#3d2008)",borderRadius:18,padding:"16px 18px",textDecoration:"none",border:"1px solid rgba(107,66,38,0.4)"}}>
          <div style={{width:44,height:44,borderRadius:14,background:"linear-gradient(135deg,#6b4226,#9a6342)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
