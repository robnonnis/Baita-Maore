...
const TR = {
  it: {
    ...
    activities: [
      ...
      { emoji: "🧺", title: "Aperitivo nel bosco", subtitle: "O in punto panoramico", detail: "Un aperitivo al tramonto nel bosco o in uno dei punti panoramici più suggestivi di Laconi.", photos: ["https://res.cloudinary.com/dovpg47yh/image/upload/v1774646482/PHOTO-2024-08-18-13-46-26_lwblrp.jpg"], photoPosition: "center 30%" },
    ],
  ...
  en: {
    ...
    activities: [
      ...
      { emoji: "🚌", title: "Vintage Bus «Maoretto»", subtitle: "Panoramic picnic in the woods", detail: "A trip aboard our vintage Maoretto bus to a scenic viewpoint or secret forest clearing for a picnic.", price: "Picnic set € 75 per couple", photos: ["https://res.cloudinary.com/dovpg47yh/image/upload/v1775488681/PHOTO-2026-03-29-20-52-16_12_jadhd9.jpg"], photoPosition: "center 30%" },
      { emoji: "🧺", title: "Aperitif in the woods", subtitle: "Or at a panoramic viewpoint", detail: "A sunset aperitif in the woods or at one of Laconi's most breathtaking viewpoints. A romantic and authentic experience.", photos: ["https://res.cloudinary.com/dovpg47yh/image/upload/v1774646482/PHOTO-2024-08-18-13-46-26_lwblrp.jpg"], photoPosition: "center 30%" },
    ],
